...
Frontend developer diving deep into TypeScript, React, Next.js, React Native, Node and Ruby on Rails. While initially started my programming journey with backend development, later I switched to frontend development, exploring both sides successfully. 
